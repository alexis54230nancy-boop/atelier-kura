      ...
      <section className="px-4 py-14">
        <div className="mx-auto grid w-[min(1280px,100%)] gap-8 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <div className="rounded-[34px] border border-white/10 bg-white/[0.035] p-8 shadow-2xl backdrop-blur-xl md:p-10">
            ...
            <p className="mt-5 text-2xl font-semibold">65,00€</p>

            <p className="mt-6 max-w-xl text-base leading-8 text-white/68">
              Tee épais en jersey premium, pensé comme une base silencieuse :
              dense, minimale, nette. Une pièce quotidienne, mais jamais neutre.
            </p>
            ...
            <div className="mt-10 space-y-5 border-t border-white/10 pt-8 text-sm leading-7 text-white/62">
              <p>
                <strong className="text-white">Composition :</strong> jersey
                coton 240 GSM.
              </p>
              <p>
                <strong className="text-white">Coupe :</strong> droite,
                structurée, légèrement ample.
              </p>
              <p>
                <strong className="text-white">Détails :</strong> logo discret,
                col renforcé, finition premium.
              </p>
              <p>
