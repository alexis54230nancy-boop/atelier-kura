                      ...
                      {product.image ? (
                        ...
                        <>
                          ...
                          <div className="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden px-4">
                            <div className="select-none text-center font-[family-name:var(--font-after)] text-[clamp(3.5rem,14vw,8rem)] font-[300] italic leading-[0.88] tracking-[-0.04em] text-white/[0.038] transition duration-700 group-hover:text-white/[0.055]">
                              {name}
                            </div>
                          </div>
                        </>
